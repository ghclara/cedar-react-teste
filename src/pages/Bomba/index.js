...
export default class Graphics extends Component {
    ...
    async prepare_map() {
        let definitions = {
            ...
            "datasets": [
              {
                "url": "https://geoportal.corsan.com.br/server/rest/services/POC/POC_DashboardCCO/MapServer/1",
                "query": {
            ...
            "series": [{
                "category": {"field": "STATUSCCO", "label": ""},
                "value": {
                    "field": "NUMBER_OF_SUM",
                    "label": ""
                  }
    ...
    render() {
      return (
        <div id="chart-bomba" style={{ height: '100%' }}>
        </div>
      )
    }
}